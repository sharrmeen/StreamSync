...
//       try {
//         // Fetch the live stream URL with userId and initial time (T=0)
//         const initialTime = 0; // Start at T=0
//         const liveStream = await getLiveStream(userId, initialTime);
...
//   }, [userId, navigate]); // Dependencies: userId and navigate (currentTime removed)
